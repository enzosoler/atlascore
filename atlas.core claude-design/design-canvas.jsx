  ...
  React.useEffect(() => {
    ...
    const onWheel = (e) => {
      ...
      if (e.ctrlKey || e.metaKey) {
        // trackpad pinch OR explicit ctrl/cmd+wheel → zoom
        zoomAt(e.clientX, e.clientY, Math.exp(-e.deltaY * 0.01));
      } else {
        // everything else — mouse wheel AND trackpad two-finger scroll — pans
        // (shift swaps axes, matching browser convention)
        const t = tf.current;
