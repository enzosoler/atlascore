...
- **Save path:** `/Users/enzosoler/Documents/Atlas.Core/atlas.core-official/screenshots/paywall-review-screenshot.png`
...
### Output
- **Save path:** `/Users/enzosoler/Documents/Atlas.Core/atlas.core-official/screenshots/watch-screenshots/`
...
### Output
- **Save path:** `/Users/enzosoler/Documents/Atlas.Core/atlas.core-official/screenshots/ipad-screenshots/`
...
Drop all files in:
- `/screenshots/paywall-review-screenshot.png` (1 file)
- `/screenshots/watch-screenshots/01-main-list.png`, `02-today-glance.png`, `03-active-workout.png` (3 files)
- `/screenshots/ipad-screenshots/01.png`, `02.png`, `03.png` (3 files, only if keeping iPad)
