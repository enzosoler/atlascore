...
- `[x]` 2026-04-20 — Search service 503 — root cause: EXERCISEDB_API_KEY secret unset → edge fn returns 503. Added server-side 3-attempt retry (600ms/1500ms) + ISO timestamp structured logs. Client-side retry (800ms/2000ms backoff) on 5xx/429/timeout. Remaining fix: supabase secrets set EXERCISEDB_API_KEY=<key>. Commit: 3ea9b61.
...
- 3ea9b61 fix(search): retry + structured logging for exercise-search (client + edge fn)
- be5e970 feat(i18n): wire V3MarketingLayout nav/CTA/footer through t()
