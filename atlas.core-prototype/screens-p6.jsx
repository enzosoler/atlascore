      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '14px 22px 20px' }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{
              padding: '4px 0',
              borderTop: i >= 2 ? `1px solid ${c.bg}14` : 'none',
              paddingTop: i >= 2 ? 16 : 0,
              paddingLeft: i % 2 === 1 ? 16 : 0,
              borderLeft: i % 2 === 1 ? `1px solid ${c.bg}14` : 'none',
            }}>
              <div style={{ fontFamily: ACFonts.mono, fontSize: 9, color: c.bg, opacity: 0.55, letterSpacing: 0.7, textTransform: 'uppercase' }}>{m.k}</div>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginTop: 6 }}>
                ...
                <span style={{ fontFamily: ACFonts.mono, fontSize: 10, color: c.bg, opacity: 0.5 }}>{m.u}</span>
              </div>
            </div>
          ))}
        </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontFamily: ACFonts.mono, fontSize: 11, color: 'rgba(239,233,218,0.6)', marginTop: 4, letterSpacing: 0.3 }}>
                  @marcus · joined JAN 24
                </div>
                <div style={{ marginTop: 10, fontSize: 13, color: 'rgba(239,233,218,0.78)', lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontFamily: ACFonts.mono, fontSize: 9, color: 'rgba(239,233,218,0.5)', letterSpacing: 0.7, textTransform: 'uppercase' }}>{m.k}</div>
                  <div style={{ fontFamily: ACFonts.display, fontSize: 24, fontWeight: 700, letterSpacing: -0.8, marginTop: 4 }}>{m.v}</div>
                </div>
              ))}
            </div>
          </div>
