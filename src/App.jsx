...
import AppLayout from '@/components/layout/AppLayoutV2.jsx';
...
const Today = lazy(() => import('@/pages/Dashboard'));
const Nutrition = lazy(() => import('@/pages/Nutrition'));
const WorkoutsV2 = lazy(() => import('@/pages/Workout'));
...
const AdminLayout = lazy(() => import('@/components/admin/AdminLayoutV2'));
...
const ProgressPhotos = lazy(() => import('@/pages/ProgressPhotosV2'));
...
const Progress = lazy(() => import('@/pages/ProgressV2'));
