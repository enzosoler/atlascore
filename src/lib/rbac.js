...
export const NAV_BY_ROLE = {
  ...
  coach: [
    ...
    { path: ROUTES.coachStudents,      label: 'Alunos',         icon: 'Users' },
  ...
  nutritionist: [
    ...
    { path: ROUTES.nutritionistClients,     label: 'Clientes',     icon: 'Users' },
    { path: ROUTES.social,                  label: 'Social',       icon: 'MessageSquare' },
    { path: ROUTES.export,                  label: 'Exportar',     icon: 'Download' },
    { path: ROUTES.profile,                 label: 'Perfil',       icon: 'User' },
  ],
  clinician: [
    ...
    { path: ROUTES.clinicianPatients,    label: 'Pacientes',     icon: 'Users' },
    { path: ROUTES.social,               label: 'Social',        icon: 'MessageSquare' },
    { path: ROUTES.export,               label: 'Exportar',      icon: 'Download' },
    { path: ROUTES.profile,              label: 'Perfil',        icon: 'User' },
  ],
