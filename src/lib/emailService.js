  ...
  supabase.functions
    ...
    .then(({ data, error }) => {
      if (error) {
        ...
        if (import.meta.env.DEV) console.log(`[emailService] ✓ ${type} → ${to} (id: ${data?.id})`);
      }
    })
    .catch((err) => {
...
export const email = {
   ...
   * @param {string} [params.language]  - Locale hint (normalised to 'en')
   ...
   * @param {string} [params.email]      - Recipient email address
   * @param {string} [params.firstName]  - User first name
   * @param {string} [params.confirmUrl] - Confirmation link URL
   * @param {string} [params.language]   - Locale hint (normalised to 'en')
   * @param {string} [params.userId]     - Supabase user ID
   */
   ...
   * @param {string} [params.email]          - Recipient email address
   * @param {string} [params.firstName]      - User first name
   * @param {number} [params.trialDaysLeft]  - Days remaining in trial (default 7)
   * @param {string} [params.language]       - Locale hint (normalised to 'en')
   * @param {string} [params.userId]         - Supabase user ID
   */
   ...
   * @param {string} [params.email]          - Recipient email address
   * @param {string} [params.firstName]      - User first name
   * @param {number} [params.trialDaysLeft]  - Days remaining in trial (default 2)
   * @param {string} [params.trialEndsAt]    - ISO date when trial ends
   * @param {string} [params.language]       - Locale hint (normalised to 'en')
   * @param {string} [params.userId]         - Supabase user ID
   */
   ...
   * @param {string} [params.email]            - Recipient email address
   * @param {string} [params.firstName]        - User first name
   * @param {number} [params.lastActivityDays] - Days since last activity (default 4)
   * @param {string} [params.language]         - Locale hint (normalised to 'en')
   * @param {string} [params.userId]           - Supabase user ID
   */
   ...
   * @param {string} [params.email]        - Recipient email address
   * @param {string} [params.firstName]    - User first name
   * @param {string} [params.milestoneKey] - Use MILESTONE_KEYS constants (e.g. 'first_workout')
   * @param {string} [params.language]     - Locale hint (normalised to 'en')
   * @param {string} [params.userId]       - Supabase user ID
   */
 ...
 * @param {string} [params.email]     - Recipient email address
 * @param {string} [params.firstName] - User first name
 * @param {string} [params.language]  - Locale hint
 */
