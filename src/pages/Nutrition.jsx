...
const MOCK_PROTOCOLS = [
  {
    id: 'mock-protocol-1',
    name: 'Creatina',
    substance_name: 'Creatina Monohidratada',
    category: 'Suplemento',
    dose: '5g',
    frequency: 'Diariamente',
    notes: 'Tomar com a primeira refeicao do dia.',
  ...
  },
  {
    id: 'mock-protocol-2',
    name: 'Magnesio',
    substance_name: 'Bisglicinato de Magnesio',
    category: 'Suplemento',
    dose: '2 capsulas',
    frequency: 'Noite',
    notes: 'Uso pausado durante ajuste do plano.',
  ...
  },
  {
    id: 'mock-protocol-3',
    name: 'Omega 3',
    substance_name: 'Omega 3',
    category: 'Suplemento',
    dose: '2 capsulas',
    frequency: 'Almoco e jantar',
    notes: 'Ciclo encerrado no ultimo mes.',
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-600">
              {protocol?.dose || 'Dose nao definida'} · {protocol?.frequency || 'Frequencia nao definida'}
            </p>
          </div>
  ...
  return (
    ...
    >
      <StatusBanner tone="warning">
        Proximo ponto de falha encontrado nesta rota: <strong>src/pages/Nutrition.jsx</strong>{' '}
