        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="text-center mb-8">
            ...
            <p className="text-[hsl(var(--fg-2))]">
              14 days of Premium access, completely free
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl bg-[hsl(var(--fill))] mb-6">
            ...
            <div className="text-sm">
              <p className="font-medium">Trial ends Feb 14, 2024</p>
          ...
          <p className="text-center mt-4 text-xs text-[hsl(var(--fg-3))]">
            ...
            You can cancel anytime before {new Date(Date.now() + 14 * 24 * 60 * 60 * 1000).toLocaleDateString()}.
          </p>
        </motion.div>
      </div>
    </div>
