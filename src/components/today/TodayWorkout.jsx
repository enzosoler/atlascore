  ...
  return (
    <Link to={ROUTES.workouts} className="block p-5 rounded-2xl bg-card border border-border hover:border-border/80 transition-colors">
      <div className="flex items-center justify-between mb-4">
        <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-widest">Workout</p>
      ...
      {w ? (
        ...
        <div className="py-3">
          ...
          <p className="text-[12px] text-[hsl(var(--primary))] mt-1 font-medium">Log one or generate one →</p>
        </div>
      )}
    </Link>
  );
